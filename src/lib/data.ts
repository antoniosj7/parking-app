...
export const parkingSessions: ParkingSession[] = [
  { id: 'sess-1', spotId: 'P1', user: 'User5', startTime: '09:15', duration: '2h 15m', status: 'active' },
  { id: 'sess-2', spotId: 'P4', user: 'User12', startTime: '10:30', duration: '1h 0m', status: 'active' },
  { id: 'sess-3', spotId: 'P2', user: 'User3', startTime: '08:45', duration: '2h 45m', status: 'active' },
  { id: 'sess-5', spotId: 'C1', user: 'UserX', startTime: '11:00', duration: '0h 30m', status: 'completed' },
  { id: 'sess-4', spotId: 'P3', user: 'User20', startTime: '11:05', duration: '0h 25m', status: 'active' },
];
