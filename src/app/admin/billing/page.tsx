            ...
            <Card className="border-dashed">
                ...
                <CardContent>
                    <p className="text-muted-foreground mt-2">
                        Esta sección está actualmente en desarrollo. Aquí podrás configurar las tarifas por tiempo, ver los cobros pendientes y generar recibos para las sesiones finalizadas.
                    </p>
                </CardContent>
            </Card>
        </div>
