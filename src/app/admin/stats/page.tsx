            ...
            <Card className="border-dashed">
                ...
                <CardContent>
                    <p className="text-muted-foreground mt-2">
                        Esta sección está actualmente en desarrollo. Se están realizando ajustes para asegurar la estabilidad del despliegue. Próximamente aquí podrás visualizar las métricas y gráficas de rendimiento del parqueo.
                    </p>
                </CardContent>
            </Card>
